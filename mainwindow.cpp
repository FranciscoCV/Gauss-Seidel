...
MainWindow::~MainWindow()
{
 ...
 void MainWindow::Metodo (){   // method to use to solve the program
   ...
   double x1=0.0, x2=0, x3=0, x4=0, x11=0, x22=0, x33=0, x44=0, er1=0, er2=0, er=0, erx4=0,salida=0;
   int iinteraciones=0;   // the iteration variable is initialized to zero

   while((iinteraciones<It)&&(salida<err)){    // repetitive cycle while. while the number of iterations performed by the program is less than the iterations established by the user or the output is less than the error entered by the user, the cycle will be executed
